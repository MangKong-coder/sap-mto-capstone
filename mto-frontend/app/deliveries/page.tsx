          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Transaction Code: VL01N - Create Outbound Delivery</p>
              </div>
            ...
            <div className="p-4 border-b border-border">
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  ...
                  <Input
                    placeholder="Search by delivery number, customer, or sales order..."
                    value={searchQuery}
